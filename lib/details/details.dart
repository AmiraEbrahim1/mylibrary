...
class DetailsView extends StatelessWidget {
  DetailsView({required this.name, required this.img, required this.price ,required this.number});

  String price, name, img , number;
          ...
          Container(
            ...
            child: Center(
              child: Text(
                '1',
                style: TextStyle(
                    fontSize: 16, color: Color.fromRGBO(168, 146, 84, 1)),
              ),
            ),
          ),
          Padding(
